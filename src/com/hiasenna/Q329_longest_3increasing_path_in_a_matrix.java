...
/**
 * @ClassName Q329_longest_3increasing_path_in_a_matrix
 * @Description T0D0
 * @Author zhanghaoyu
 * @Date 2020/7/26-1:08
 * @Version 1.0
 **/
public class Q329_longest_3increasing_path_in_a_matrix {
    ...
    public int dfs(int[][] matrix, int row, int col, int[][] dp, int prev) {
        if (row > matrix.length - 1 || row < 0 || col > matrix[0].length - 1 || col < 0 || matrix[row][col] <= prev)
            return 0;
